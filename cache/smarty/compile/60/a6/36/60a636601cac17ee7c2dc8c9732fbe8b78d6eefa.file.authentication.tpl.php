<?php /* Smarty version Smarty-3.1.19, created on 2016-09-07 22:28:58
         compiled from "/home/denfish/denfish.com/www/themes/denfish/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:39260618257d06a7a1d3052-48730905%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60a636601cac17ee7c2dc8c9732fbe8b78d6eefa' => 
    array (
      0 => '/home/denfish/denfish.com/www/themes/denfish/authentication.tpl',
      1 => 1470841513,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '39260618257d06a7a1d3052-48730905',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d06a7a8db934_92754211',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d06a7a8db934_92754211')) {function content_57d06a7a8db934_92754211($_smarty_tpl) {?>
<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?>
	<?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)) {?><?php echo smartyTranslate(array('s'=>'Авторизация'),$_smarty_tpl);?>
<?php } else { ?>
...
"><?php echo smartyTranslate(array('s'=>'Авторизация'),$_smarty_tpl);?>
</a>
		<span class="navigation-pipe"><?php echo $_smarty_tpl->tpl_vars['navigationPipe']->value;?>
</span><?php echo smartyTranslate(array('s'=>'Регистрация'),$_smarty_tpl);?>
...
?>
	...
	<?php }?>-->
	<div class="row">
		<div id="center_column" class="col-xs-12 col-sm-6">
...
" method="post" id="create-account_form" class="box">
				<h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Создать учетную запись'),$_smarty_tpl);?>
</h3>
				<div class="form_content clearfix">
					<p><?php echo smartyTranslate(array('s'=>'Введите свой e-mail для создания учетной записи'),$_smarty_tpl);?>
</p>
					<div class="alert alert-danger" id="create_account_error" style="display:none"></div>
					<div class="form-group">
						<label for="email_create"><?php echo smartyTranslate(array('s'=>'E-mail:'),$_smarty_tpl);?>
</label>
...
" method="post" id="login_form" class="box">
				<h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Уже зарегестрированы?'),$_smarty_tpl);?>
</h3>
				<div class="form_content clearfix">
					<div class="form-group">
...
<?php }?>" />
					...
					<div class="form-group">
						<label for="passwd"><?php echo smartyTranslate(array('s'=>'Пароль:'),$_smarty_tpl);?>
</label>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Забыли пароль?'),$_smarty_tpl);?>
</a></p>
					<p class="submit">
						<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
...
" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			<h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Регистрация'),$_smarty_tpl);?>
</h3>
			<div class="clearfix">
				<!--<label><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</label>
...
<?php }?>" />
				<label for="customer_firstname"><?php echo smartyTranslate(array('s'=>'Имя'),$_smarty_tpl);?>
 <sup>*</sup></label>
			</div>
			<div class="required form-group">
...
<?php }?>" />
				<label for="customer_lastname"><?php echo smartyTranslate(array('s'=>'Фамилия'),$_smarty_tpl);?>
 <sup>*</sup></label>
			</div>
			<div class="required form-group">
...
<?php }?>" />
 ...
 <sup>*</sup></label>
			...
			<div class="required password form-group">
				...
				<label for="passwd"><?php echo smartyTranslate(array('s'=>'Пароль(не менее 5 символов)'),$_smarty_tpl);?>
 <sup>*</sup></label>
			</div> 
			<!--<div class="form-group">
				<label><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
...
" /><?php }?>
			<div class="clearfix">
			<p class="pull-left required"><span><sup>*</sup><?php echo smartyTranslate(array('s'=>'обязательны к заполнению'),$_smarty_tpl);?>
</span></p>
			</div>
