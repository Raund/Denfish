<?php /* Smarty version Smarty-3.1.19, created on 2016-09-01 19:52:21
         compiled from "/home/denfish/denfish.com/www/themes/denfish/product-sort.tpl" */ ?>
<?php /*%%SmartyHeaderCode:196295969257c85cc5a32554-99532860%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '769c4560fa2e45ee1e999977b9a18b13d9aaffc9' => 
    array (
      0 => '/home/denfish/denfish.com/www/themes/denfish/product-sort.tpl',
      1 => 1470841520,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '196295969257c85cc5a32554-99532860',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c85cc5b13f27_15610755',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c85cc5b13f27_15610755')) {function content_57c85cc5b13f27_15610755($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['orderby']->value)&&isset($_smarty_tpl->tpl_vars['orderway']->value)) {?>
...
<?php }?>"><?php echo smartyTranslate(array('s'=>'Сортировать:'),$_smarty_tpl);?>
</label> -->
...
" ></option>
				<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
					<option value="price:asc" <?php if ($_smarty_tpl->tpl_vars['orderby']->value=='price'&&$_smarty_tpl->tpl_vars['orderway']->value=='asc') {?>selected="selected"<?php }?><?php if ($_smarty_tpl->tpl_vars['orderby']->value==$_smarty_tpl->tpl_vars['orderbydefault']->value) {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'По возростанию цены'),$_smarty_tpl);?>
</option>
					<option value="price:desc" <?php if ($_smarty_tpl->tpl_vars['orderby']->value=='price'&&$_smarty_tpl->tpl_vars['orderway']->value=='desc') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'По убыванию цены'),$_smarty_tpl);?>
</option>
				<?php }?>
				<option value="name:asc" <?php if ($_smarty_tpl->tpl_vars['orderby']->value=='name'&&$_smarty_tpl->tpl_vars['orderway']->value=='asc') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'От А до Я'),$_smarty_tpl);?>
</option>
				<option value="name:desc" <?php if ($_smarty_tpl->tpl_vars['orderby']->value=='name'&&$_smarty_tpl->tpl_vars['orderway']->value=='desc') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'От Я до А'),$_smarty_tpl);?>
</option>
				<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
					<option value="quantity:desc" <?php if ($_smarty_tpl->tpl_vars['orderby']->value=='quantity'&&$_smarty_tpl->tpl_vars['orderway']->value=='desc') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'В наличии'),$_smarty_tpl);?>
</option>
				<?php }?>
			</select>
		</div>
