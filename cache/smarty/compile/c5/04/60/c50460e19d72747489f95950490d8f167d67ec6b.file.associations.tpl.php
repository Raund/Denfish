<?php /* Smarty version Smarty-3.1.19, created on 2016-09-01 16:50:29
         compiled from "/home/denfish/denfish.com/www/admin6912/themes/default/template/controllers/products/associations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:151488766057c83225d96966-52426190%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c50460e19d72747489f95950490d8f167d67ec6b' => 
    array (
      0 => '/home/denfish/denfish.com/www/admin6912/themes/default/template/controllers/products/associations.tpl',
      1 => 1470840435,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151488766057c83225d96966-52426190',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c83225dfd218_70187828',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c83225dfd218_70187828')) {function content_57c83225dfd218_70187828($_smarty_tpl) {?>
<div id="product-associations" class="panel product-tab">
	...
	<div class="form-group">
		...
		<label class="control-label col-lg-2" for="category_block">
			<?php echo smartyTranslate(array('s'=>'Связанные категории'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['id_category_default']->value==$_smarty_tpl->tpl_vars['cat']->value['id_category']) {?>selected="selected"<?php }?> ><?php echo $_smarty_tpl->tpl_vars['cat']->value['name'];?>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="product_autocomplete_input">
			...
			title="<?php echo smartyTranslate(array('s'=>'Выбор моделей для этого товара'),$_smarty_tpl);?>
...
">
			<?php echo smartyTranslate(array('s'=>'Выбор моделей для этого товара'),$_smarty_tpl);?>
...
<?php }?>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="id_manufacturer"><?php echo smartyTranslate(array('s'=>'Производитель'),$_smarty_tpl);?>
</label>
		<div class="col-lg-5">
