<?php /* Smarty version Smarty-3.1.19, created on 2016-09-20 14:44:54
         compiled from "D:\Webserver\domains\denfish.my\themes\denfish\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1690657e1213615b704-22960162%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2050d0d6f6211c46db43fe5f112c2ac064f6554c' => 
    array (
      0 => 'D:\\Webserver\\domains\\denfish.my\\themes\\denfish\\modules\\blockcart\\blockcart.tpl',
      1 => 1474371406,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1690657e1213615b704-22960162',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57e12136845124_93702231',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57e12136845124_93702231')) {function content_57e12136845124_93702231($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\Webserver\\domains\\denfish.my\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'D:\\Webserver\\domains\\denfish.my\\tools\\smarty\\plugins\\function.counter.php';
?>
<!-- MODULE Block cart -->
...
" rel="nofollow">
			...
			<!--<span class=" price ajax_cart_quantity<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value==0) {?> unvisible<?php }?>"style="display:none"><?php echo $_smarty_tpl->tpl_vars['cart_qties']->value;?>
</span>
			<span class="ajax_cart_product_txt<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value!=1) {?> unvisible<?php }?>" style="display:none"><?php echo smartyTranslate(array('s'=>'Product','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
			<span class="ajax_cart_product_txt_s<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2) {?> unvisible<?php }?>" style="display:none"><?php echo smartyTranslate(array('s'=>'Products','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
			<span class="ajax_cart_total<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value==0) {?> unvisible<?php }?>" style="display:none">
			...
			<span class="ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>" style="display:none"></span>
		...
		<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
			<div class="cart_block block exclusive">
				<div class="block_content">
					...
					<div class="cart_block_list<?php if (isset($_smarty_tpl->tpl_vars['blockcart_top']->value)&&!$_smarty_tpl->tpl_vars['blockcart_top']->value) {?><?php if (isset($_smarty_tpl->tpl_vars['colapseExpandStatus']->value)&&$_smarty_tpl->tpl_vars['colapseExpandStatus']->value=='expanded'||!$_smarty_tpl->tpl_vars['ajax_allowed']->value||!isset($_smarty_tpl->tpl_vars['colapseExpandStatus']->value)) {?> expanded<?php } else { ?> collapsed unvisible<?php }?><?php }?>"style="display:none">
...
" rel="nofollow">
						...
						<div class="cart-prices">
							<div class="cart-prices-line first-line">
								<span class="price cart_block_shipping_cost ajax_cart_shipping_cost" style="display:none">
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
							...
							<?php }?>
							<div class="cart-prices-line last-line"style="display:none">
								<span class="price cart_block_total ajax_block_cart_total" style="display:none"><?php echo $_smarty_tpl->tpl_vars['total']->value;?>
</span>
...
"><i class="fa fa-times-circle fa-2x"></i></span>
				<h2>
					<i class="icon-ok"></i><?php echo smartyTranslate(array('s'=>'Товар успешно добавлен в корзину','mod'=>'blockcart'),$_smarty_tpl);?>
...
">
						<span>
							<i class="icon-chevron-left left"></i><?php echo smartyTranslate(array('s'=>'Продолжить покупки','mod'=>'blockcart'),$_smarty_tpl);?>
...
" rel="nofollow">
						<span>
							<?php echo smartyTranslate(array('s'=>'Оформить заказ','mod'=>'blockcart'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i>
						</span>
					</a>	
				</div>
