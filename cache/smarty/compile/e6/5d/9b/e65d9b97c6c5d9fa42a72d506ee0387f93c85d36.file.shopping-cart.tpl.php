<?php /* Smarty version Smarty-3.1.19, created on 2016-09-02 15:19:31
         compiled from "/home/denfish/denfish.com/www/themes/denfish/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:176847048357c96e53bc2294-07588453%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e65d9b97c6c5d9fa42a72d506ee0387f93c85d36' => 
    array (
      0 => '/home/denfish/denfish.com/www/themes/denfish/shopping-cart.tpl',
      1 => 1470841521,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '176847048357c96e53bc2294-07588453',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c96e543714b2_91529500',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c96e543714b2_91529500')) {function content_57c96e543714b2_91529500($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/denfish/denfish.com/www/tools/smarty/plugins/modifier.regex_replace.php';
?>


<div id="content_cart">
<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Корзина'),$_smarty_tpl);?>
...
-->
	<?php if (!isset($_smarty_tpl->tpl_vars['empty']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
		<span class="heading-counter"><?php echo smartyTranslate(array('s'=>'Всего в корзине:'),$_smarty_tpl);?>

			<span id="summary_products_quantity"><?php echo $_smarty_tpl->tpl_vars['productNumber']->value;?>
 
			</span>
            <span><?php echo smartyTranslate(array('s'=>'Отложено покупок:'),$_smarty_tpl);?>
<!--Вписати змінну для підрахунку отлож покупок-->
                <span id="summary_products_quantity_wishlist"><?php echo intval($_smarty_tpl->tpl_vars['product']->value['quantity']);?>

			</span>
			<!--<?php if ($_smarty_tpl->tpl_vars['productNumber']->value==1) {?><?php echo smartyTranslate(array('s'=>'товар'),$_smarty_tpl);?>
<?php }?>
			<?php if (($_smarty_tpl->tpl_vars['productNumber']->value>1&&$_smarty_tpl->tpl_vars['productNumber']->value<5)) {?><?php echo smartyTranslate(array('s'=>'товара'),$_smarty_tpl);?>
<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['productNumber']->value>4) {?><?php echo smartyTranslate(array('s'=>'товаров'),$_smarty_tpl);?>
<?php }?>-->
		</span>
	<?php }?>
</h1>
...
<?php if (isset($_smarty_tpl->tpl_vars['empty']->value)) {?>
	<p class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Корзина пуста'),$_smarty_tpl);?>
</p>
...
<?php } else { ?>
	<p style="display:none" id="emptyCartWarning" class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Корзина пуста'),$_smarty_tpl);?>
</p>
...
">
	...
	<div id="order-detail-content" class="table_block table-responsive">
		<div id="cart_summary" class="table table-bordered <?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>stock-management-on<?php } else { ?>stock-management-off<?php }?>">
			<!--<thead>
				<tr>
...
<?php }?>"
			...
			>
			<i class="fa fa-angle-left fa-lg"></i><?php echo smartyTranslate(array('s'=>'Продолжить покупки'),$_smarty_tpl);?>

		</a>
		<a class="of_za x-create-order" href="#">
			Оформить заказ
		</a>
       		<span class="itogo"><?php echo smartyTranslate(array('s'=>'Итог:'),$_smarty_tpl);?>
</span>
		<span class="itogo_price" id="total_price" ><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price_without_tax']->value),$_smarty_tpl);?>
</span>
	</p>
