...
{capture name=path}<a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Все статьи от DenFish' mod='smartblog'}</a><span class="navigation-pipe">{$navigationPipe}</span>{$meta_title}{/capture}
