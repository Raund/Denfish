...
class Blockcontactinfos extends Module
{
	protected static $contact_fields = array(
		...
		'BLOCKCONTACTINFOS_COMPANY1',
		'BLOCKCONTACTINFOS_ADDRESS1',
	);
	...
	public function install()
	{
		...
		Configuration::updateValue('BLOCKCONTACTINFOS_COMPANY1', Configuration::get('PS_SHOP_NAME'));
		Configuration::updateValue('BLOCKCONTACTINFOS_ADDRESS1', trim(preg_replace('/ +/', ' ', Configuration::get('PS_SHOP_ADDR1').' '.Configuration::get('PS_SHOP_ADDR2')."\n".Configuration::get('PS_SHOP_CODE').' '.Configuration::get('PS_SHOP_CITY')."\n".Country::getNameById(Configuration::get('PS_LANG_DEFAULT'), Configuration::get('PS_SHOP_COUNTRY_ID')))));
				...
				'input' => array(
					...
					array(
						...
						'name' => 'BLOCKCONTACTINFOS_ADDRESS',
										...
										array(
						'type' => 'text',
						'label' => $this->l('Company name1'),
						'name' => 'BLOCKCONTACTINFOS_COMPANY1',
					),
					array(
						'type' => 'textarea',
						'label' => $this->l('Address1'),
						'name' => 'BLOCKCONTACTINFOS_ADDRESS1',
					),
					/*array(
						'type' => 'text',
