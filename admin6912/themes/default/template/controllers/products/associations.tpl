...
<div id="product-associations" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="product_autocomplete_input">
			...
			title="{l s='Выбор моделей для этого товара'}{l s='Start by typing the first letters of the product\'s name, then select the product from the drop-down list.'}{l s='Do not forget to save the product afterwards!'}">
			{l s='Выбор моделей для этого товара'}
			</span>
		</label>
		<div class="col-lg-5">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="id_manufacturer">{l s='Производитель'}</label>
		<div class="col-lg-5">
