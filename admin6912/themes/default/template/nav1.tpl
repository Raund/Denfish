<div class="bootstrap">
	<nav id="{if $employee->bo_menu}nav-sidebar{else}nav-topbar{/if}" role="navigation">
		...
		<ul class="menu">
			...
			{/foreach}
            <li class="maintab">
                <a href="http://denfish.com/admin6912/index.php?controller=AdminModules&token=7761059df8988998e41a18f7fa3d91ec&configure=wnnews&tab_module=others&module_name=wnnews" class="title" >
                    <i class="icon-{$t.class_name}"></i>
                    <span>Советы от Denfish</span>
                </a>
            </li>
            <li class="maintab">
                <a href="http://denfish.com/admin6912/index.php?controller=AdminModules&token=7761059df8988998e41a18f7fa3d91ec&configure=azgallery&tab_module=front_office_features&module_name=azgallery" class="title" >
                    <i class="icon-{$t.class_name}"></i>
                    <span>Фотогалерея Denfish</span>
                </a>
            </li>
            <li class="maintab">
                <a href="http://denfish.com/admin6912/index.php?controller=AdminBlogPost&token=fc3f2be1ec606cad71a3d79ae6d99c4b" class="title"  >
                    <i class="icon-{$t.class_name}"></i>
