...
*}
{capture name=path}
	{if !isset($email_create)}{l s='Авторизация'}{else}
		<a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Authentication'}">{l s='Авторизация'}</a>
		<span class="navigation-pipe">{$navigationPipe}</span>{l s='Регистрация'}
	{/if}
{/capture}
	...
	<div class="row">
		<div id="center_column" class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
				<h3 class="page-subheading">{l s='Создать учетную запись'}</h3>
				<div class="form_content clearfix">
					<p>{l s='Введите свой e-mail для создания учетной записи'}</p>
					<div class="alert alert-danger" id="create_account_error" style="display:none"></div>
					<div class="form-group">
						<label for="email_create">{l s='E-mail:'}</label>
		...
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
				<h3 class="page-subheading">{l s='Уже зарегестрированы?'}</h3>
				<div class="form_content clearfix">
					<div class="form-group">
					...
					<div class="form-group">
						<label for="passwd">{l s='Пароль:'}</label>
					...
					<p class="lost_password form-group"><a href="{$link->getPageLink('password')|escape:'html':'UTF-8'}" title="{l s='Recover your forgotten password'}" rel="nofollow">{l s='Забыли пароль?'}</a></p>
					<p class="submit">
						{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			<h3 class="page-subheading">{l s='Регистрация'}</h3>
			<div class="clearfix">
				<!--<label>{l s='Title'}</label>
				<br />
				{foreach from=$genders key=k item=gender}
			...
			<div class="required form-group">
				...
				<label for="customer_firstname">{l s='Имя'} <sup>*</sup></label>
			</div>
			<div class="required form-group">
				...
				<label for="customer_lastname">{l s='Фамилия'} <sup>*</sup></label>
			</div>
			<div class="required form-group">
			...
			<div class="required password form-group">
				...
				<label for="passwd">{l s='Пароль(не менее 5 символов)'} <sup>*</sup></label>
			</div> 
			<!--<div class="form-group">
				<label>{l s='Date of Birth'}</label>
				<div class="row">
		...
		<div class="submit clearfix">
			...
			{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
			<div class="clearfix">
			<p class="pull-left required"><span><sup>*</sup>{l s='обязательны к заполнению'}</span></p>
			</div>
