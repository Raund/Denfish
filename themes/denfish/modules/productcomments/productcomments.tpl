...
<div id="idTab5">
	<div id="product_comments_block_tab">
		...
		{else}
			...
			{else}
			<p class="align_center">{l s='Нет ни одного отзыва на данный момент.'}</p>
			{/if}
		{/if}
...
{addJsDefL name=productcomment_added_moderation}{l s='Ваш комментарий был добавлен и будет утвержден после проверки модератором.' mod='productcomments' js=1}{/addJsDefL}
