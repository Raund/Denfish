...
<div class="header_user_info">
	...
	{else}
		<a class="login x-show-login" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Log in to your customer account' mod='blockuserinfo'}">
