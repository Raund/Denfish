...
<head>
 ...
 {foreach from=$css_files key=css_uri item=media}
    <link href="{$css_uri}?ver0.6" rel="stylesheet" type="text/css" media="{$media}" />
 {/foreach}
 ...
 {if isset($js_defer) && !$js_defer && isset($js_files) && isset($js_def)}
	...
	<script type="text/javascript" src="{$js_uri|escape:'html':'UTF-8'}?ver0.6"></script>
	{/foreach}
